...
export default function RecipeCard({
    ...
    return (
        ...
        >
            ...
            {/* Delete button (relocated to bottom-right to avoid drag handle overlap) */}
            {onDelete && (
                <button
                    onClick={handleDeleteClick}
                    className="absolute bottom-10 right-4 text-slate-300 dark:text-slate-700 hover:text-red-500 transition-colors z-10 p-2 bg-panel/50 backdrop-blur-sm rounded-xl shadow-sm border border-line"
            ...
            {/* Stats row */}
            <div className="flex flex-wrap gap-4 mt-5 text-sm text-slate-600 dark:text-slate-400 font-bold border-t border-line pt-4 pb-2 pr-12">
